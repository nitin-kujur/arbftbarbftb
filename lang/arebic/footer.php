			...
			<div class="container-fluid w3-padding-0">
				<div class="row toUpper text-center w3-text-white">
					<div class="col-md-4 w3-hover-shadow">
						...
						<h6 class="w3-small">24/7 رعاية العملاء </h6>			
					</div>
					<div class="col-md-4 w3-hover-shadow">
						<img class="img-responsive center-block" style="width:90px;" src="images/RBC.png">
						<h6 class="w3-small">Resend تأكيد الحجز</h6>			
					</div>
					<div class="col-md-4 w3-hover-shadow">
			...
			<div class="container">
				<div class="row text-center w3-text-white toUpper">
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">رياضة</button>	
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">السينما</button>	
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">المواقف</button>	
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">ميترو</button>	
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">الاشعارات</button>	
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6">
						<button type="button" class="w3-btn btn-sm w3-grey2 w3-section footer-menu-btn">تذاكري</button>	
					</div>
				</div>
			</div>	
