		...
		<div id="myNavbar3" class="collapse1 navbar-collapse1 w3-padding-0">
			<ul id="myNavbar3-child" class="nav navbar-nav navbar-dark toUpper w3-text-gray">
				  ...
				  <li id="tab-li3" class="w3-dropdown-hover">
				  	<a class="w3-transparent dropdown-toggle" tabindex="-1" data-toggle="dropdown" href="javascript:;"><h6 class="text-center"><span>&nbsp;&nbsp;&nbsp;</span>عرض حسب السعر<span>&nbsp;&nbsp;<i class="fa fa-angle-down"></i>&nbsp;</span></h6></a>
				  	<ul class="dropdown-menu text-center toUpper w3-padding w3-dropdown-content w3-white w3-card-4"> 
				  ...
				  <li id="tab-li4" class="w3-dropdown-hover">
				  	<a class="w3-transparent dropdown-toggle" tabindex="-1" data-toggle="dropdown" href="javascript:;"><h6 class="text-center"><span>&nbsp;&nbsp;&nbsp;</span>عرض حسب المكان<span>&nbsp;&nbsp;<i class="fa fa-angle-down"></i>&nbsp;</span></h6></a>
				  	<ul class="dropdown-menu text-center toUpper w3-padding w3-dropdown-content w3-white w3-card-4"> 
