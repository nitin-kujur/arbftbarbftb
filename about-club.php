			...
			<div class="col-md-8 padding-25">
				<div class="w3-white col-xs-12 w3-card-1 w3-round padding-15">
					...
					<div class="w3-row">
						...
						<div class="w3-col s6">
							<h6 class="w3-right"><a  data-toggle="tab" href="#aboutEdit" onclick="aboutTxtFocus('#aboutTxt');"><img class="img-responsive center-block" style="width:30px; height:auto;" src="images/edit-ico.png"></a></h6>
						</div>
					</div>
